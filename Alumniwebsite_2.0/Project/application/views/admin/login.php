			...
			<div class="right-content">
				...
				<div class="login-content">
					...
					<p class="text-center text-grey-darker">
						&copy; <?php echo date('Y'); ?> <a href="<?php echo $this->db->get_where('setting', array('setting_id' => 9))->row()->content; ?>" target="_blank"><?php echo $this->db->get_where('setting', array('setting_id' => 3))->row()->content;; ?></a>, All rights reserved.
					</p>
					<?php echo form_close(); ?>
				</div>
				<!-- end login-content -->
