...
//
//   @override
//   State<Runtime_Polymorphism> createState() => _InheritanceState();
// }
//
// class _InheritanceState extends State<Runtime_Polymorphism> {
//   bool isLoading = true;
...
//     ..loadRequest(Uri.parse('https://www.geeksforgeeks.org/difference-between-compile-time-and-run-time-polymorphism-in-java/'));
//   @override
...
//                 ),
//               ),
//               title: const Text("Runtime_Polymorphism"),
//               titleSpacing: 0.0,
//               centerTitle: true,
//               toolbarHeight: 60.0,
//               toolbarOpacity: 0.8,
...
//             Navigator.push(
//               context,
//               MaterialPageRoute(builder: (context) => Compile_Polymorphism()),
//             );
//           }),
//           buildMenuItem('Object and Classes', () {
//             Navigator.pop(context); // Close the drawer
//             Navigator.push(
//               context,
