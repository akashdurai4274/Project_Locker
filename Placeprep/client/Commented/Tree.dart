...
// //
// //   @override
// //   State<Tree> createState() => _InheritanceState();
// // }
// //
// // class _InheritanceState extends State<Tree> {
// //   bool isLoading = true;
...
// //     ..loadRequest(Uri.parse('https://www.geeksforgeeks.org/tree-data-structure/?ref=lbp'));
// //   @override
...
// // import 'package:webview_flutter/webview_flutter.dart';
// class Tree extends StatefulWidget {
//   const Tree({super.key, required List<Center> children});
//
//   @override
//   State<Tree> createState() => _InheritanceState();
// }
...
//   final controller = WebViewController()
//     ..setJavaScriptMode(JavaScriptMode.disabled)
//     ..loadRequest(Uri.parse('https://www.geeksforgeeks.org/stack-data-structure/?ref=lbp'));
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
