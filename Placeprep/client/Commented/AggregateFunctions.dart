...
//
//   @override
//   State<AggregateFunctions> createState() => _InheritanceState();
// }
//
// class _InheritanceState extends State<AggregateFunctions> {
//   bool isLoading = true;
...
//     ..loadRequest(Uri.parse('https://www.geeksforgeeks.org/aggregate-functions-in-sql/?ref=lbp'));
//   @override
...
//                 ),
//               ),
//               title: const Text("Aggregate Functions"),
//               titleSpacing: 0.0,
//               centerTitle: true,
//               toolbarHeight: 60.0,
//               toolbarOpacity: 0.8,
