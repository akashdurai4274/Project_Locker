...
//
//   @override
//   State<Controlstatements> createState() => _InheritanceState();
// }
//
// class _InheritanceState extends State<Controlstatements> {
//   bool isLoading = true;
...
//     ..loadRequest(Uri.parse('https://www.geeksforgeeks.org/decision-making-javaif-else-switch-break-continue-jump/'));
//   @override
...
//                 ),
//               ),
//               title: const Text("Controlstatements"),
//               titleSpacing: 0.0,
//               centerTitle: true,
//               toolbarHeight: 60.0,
//               toolbarOpacity: 0.8,
...
//             );
//           }),
//           buildMenuItem('Compile Polymorphism', () {
//             Navigator.pop(context); // Close the drawer
//             Navigator.push(
//               context,
