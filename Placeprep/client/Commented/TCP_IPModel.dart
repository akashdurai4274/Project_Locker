...
//
// // import 'package:webview_flutter/webview_flutter.dart';
// class TCP_IPModel extends StatefulWidget {
//   const TCP_IPModel({super.key});
//
//   @override
//   State<TCP_IPModel> createState() => _InheritanceState();
// }
//
// class _InheritanceState extends State<TCP_IPModel> {
//   bool isLoading = true;
...
//     ..loadRequest(Uri.parse('https://www.geeksforgeeks.org/tcp-ip-model/?ref=lbp'));
//   @override
...
//             );
//           }),
//           buildMenuItem('Network Topology', () {
//             Navigator.pop(context); // Close the drawer
//             Navigator.push(
//               context,
//               MaterialPageRoute(builder: (context) => NetworkTopology()),
//             );
//           }),
